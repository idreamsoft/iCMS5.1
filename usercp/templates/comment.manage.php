...
<div class="pwrap">
  <div class="phead">
    <div class="phead-inner">
      <div class="phead-inner">
        <h3 class="ptitle"><span><?php echo $model['name'];?>评论</span></h3>
        <div class="clearfix articlesearchform">
          <form method="get" action="<?php echo __SELF__ ; ?>" name="form3">
            ...
            <input type="hidden" name="mid" value="<?php echo $model['id'];?>" />
            <div class="inner">
      ...
      <table class="datatable">
        ...
        <tbody>
          ...
          <tr id="tr-<?php echo $rs[$i]['id'] ; ?>">
            ...
            <td><a title="查看<?php echo $rs[$i]['username'] ; ?>的专栏" target="_blank" href="<?php echo $this->iCMS->config['publicURL'];?>/member.php?uid=<?php echo $rs[$i]['userId'] ; ?>"><?php echo $rs[$i]['username'] ; ?></a></td>
